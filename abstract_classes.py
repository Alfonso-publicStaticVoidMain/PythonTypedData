...
(*) := Concrete class implementations. Everything should be impossible to directly instantiate.
"""
...
class AbstractTuple[*Ts](GenericBase[*Ts]):
    ...
    def __init__(
        ...
        *values: type[*Ts],
        ...
        from type_validation import _validate_or_coerce_iterable, _validate_type, _validate_tuple
        ...
        object.__setattr__(self, 'item_type', item_types)
